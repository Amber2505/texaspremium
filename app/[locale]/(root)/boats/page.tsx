  ...
  return (
    <div className="font-sans leading-relaxed m-0 p-2 max-w-7xl mx-auto text-gray-800">
      ...
      <ul className="mb-4 pl-5">
        ...
        <li className="mb-2">
          <strong>{t("whyNeed.reasons.marina.title")}</strong>:{" "}
          {t("whyNeed.reasons.marina.description")}
        </li>
        <li className="mb-2">
          <strong>{t("whyNeed.reasons.vesselProtection.title")}</strong>:{" "}
          {t("whyNeed.reasons.vesselProtection.description")}
        </li>
        <li className="mb-2">
