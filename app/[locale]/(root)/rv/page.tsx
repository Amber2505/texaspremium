  ...
  return (
    <div className="font-sans leading-relaxed m-0 p-2 max-w-7xl mx-auto text-gray-800">
      ...
      <ul className="mb-4 pl-5">
        ...
        <li className="mb-2">
          <strong>{t("whyNeed.reasons.property.title")}</strong>:{" "}
          {t("whyNeed.reasons.property.description")}
        </li>
        <li className="mb-2">
        ...
        <li className="mb-2">
          <strong>{t("whyNeed.reasons.belongings.title")}</strong>:{" "}
          {t("whyNeed.reasons.belongings.description")}
        </li>
        <li className="mb-2">
          <strong>{t("whyNeed.reasons.fullTime.title")}</strong>:{" "}
          {t("whyNeed.reasons.fullTime.description")}
        </li>
      </ul>
      ...
      <div className="mb-4">
        ...
        <ul className="pl-5">
          ...
          <li>
            <strong>{t("howItWorks.coverage.items.belongings.title")}</strong>:{" "}
            {t("howItWorks.coverage.items.belongings.description")}
          </li>
          <li>
            <strong>{t("howItWorks.coverage.items.emergency.title")}</strong>:{" "}
            {t("howItWorks.coverage.items.emergency.description")}
          </li>
        </ul>
