  ...
  return (
    <div className="font-sans leading-relaxed m-0 p-2 max-w-7xl mx-auto text-gray-800">
      ...
      <ul className="mb-4 pl-5">
        <li className="mb-2">
          <strong>{t("whyNeed.reasons.dwi.title")}</strong>:{" "}
          {t("whyNeed.reasons.dwi.description")}
        </li>
        <li className="mb-2">
          <strong>{t("whyNeed.reasons.noInsurance.title")}</strong>:{" "}
          {t("whyNeed.reasons.noInsurance.description")}
        </li>
        <li className="mb-2">
          <strong>{t("whyNeed.reasons.suspended.title")}</strong>:{" "}
          {t("whyNeed.reasons.suspended.description")}
        </li>
        <li className="mb-2">
          <strong>{t("whyNeed.reasons.violations.title")}</strong>:{" "}
          {t("whyNeed.reasons.violations.description")}
        </li>
        <li className="mb-2">
          <strong>{t("whyNeed.reasons.accidents.title")}</strong>:{" "}
          {t("whyNeed.reasons.accidents.description")}
        </li>
        <li className="mb-2">
          <strong>{t("whyNeed.reasons.judgments.title")}</strong>:{" "}
          {t("whyNeed.reasons.judgments.description")}
        </li>
      </ul>
      ...
      <ol className="mb-4 pl-5">
        ...
        <li>
          ...
          <ul>
            <li>
              <strong>
                {t("howItWorks.steps.step4.mailingAddress.title")}
              </strong>
              :<br />
              {t("howItWorks.steps.step4.mailingAddress.line1")}
              <br />
              {t("howItWorks.steps.step4.mailingAddress.line2")}
              <br />
              {t("howItWorks.steps.step4.mailingAddress.line3")}
              <br />
              {t("howItWorks.steps.step4.mailingAddress.line4")}
            </li>
            <li>
              <strong>{t("howItWorks.steps.step4.fax.title")}</strong>:{" "}
              {t("howItWorks.steps.step4.fax.number")}
            </li>
            <li>
              <strong>{t("howItWorks.steps.step4.email.title")}</strong>:{" "}
              {t("howItWorks.steps.step4.email.address")}
            </li>
          </ul>
        </li>
        <li>
