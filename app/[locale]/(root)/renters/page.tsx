  ...
  return (
    <div className="font-sans leading-relaxed m-0 p-2 max-w-7xl mx-auto text-gray-800">
      ...
      <ul className="mb-4 pl-5">
        <li className="mb-2">
          <strong>{t("whyNeed.reasons.landlord.title")}</strong>:{" "}
          {t("whyNeed.reasons.landlord.description")}
        </li>
        <li className="mb-2">
        ...
        <li className="mb-2">
          <strong>{t("whyNeed.reasons.living.title")}</strong>:{" "}
          {t("whyNeed.reasons.living.description")}
        </li>
        <li className="mb-2">
          <strong>{t("whyNeed.reasons.affordable.title")}</strong>:{" "}
          {t("whyNeed.reasons.affordable.description")}
        </li>
      </ul>
